...
6. **Workstation** — the host computer and its audio routing:
   - **Virtual router** (Loopback on Mac) aggregates and routes sources — see the
     [Loopback configuration & backup guide](./home/loopback-configuration-guide.md)
     and the [router layout](./home/loopback-configuration.png):
...
![Home Studio Rig diagram](./home/home-studio-rig.svg)
...
> **Deep dives:** [Setup guide](./home/studio-rig-setup-guide.md) ·
> [Bill of materials](./home/studio-rig-bom.md) ·
> [Loopback configuration & backup](./home/loopback-configuration-guide.md)
> (router layout shown in [loopback-configuration.png](./home/loopback-configuration.png)).
...
![Travel Practice / Jam Rig diagram](./travel/travel-rig.svg)
...
![Performance Rig diagram](./performance/performance-rig.svg)
...
> **Deep dive:** [Band gig configuration](./gig/band-gig-configuration.md) —
> a full-band FOH PA (owned by bandmates) that this rig plugs into via the JDI, with
> [signal-chain](./gig/gig-signal-chains.svg) and
> [power-topology](./gig/gig-power-topology.svg) diagrams.
...
- [Sample bill of materials](./home/studio-rig-bom.md) — representative gear,
